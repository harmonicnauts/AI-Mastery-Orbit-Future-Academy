...
class Environment(tk.Tk, object):
    def __init__(self):
        ...
        self.n_actions = 4
        self.title('4x4 Maze modified by Orbit')
    ...
    def build_environment(self):
        ...
        # Obstacle 1
        self.obstacle1 = self.canvas.create_image(pixels * 2.5, pixels * 1.5, anchor='center',
                                                  image=self.obstacle1_object)
        # Obstacle 2
        self.obstacle2 = self.canvas.create_image(pixels * 4.5, pixels * 1.5, anchor='center',
                                                  image=self.obstacle1_object)
        # Obstacle 3
        self.obstacle3 = self.canvas.create_image(pixels * 0.5, pixels * 5.5, anchor='center',
                                                  image=self.obstacle1_object)
        # Obstacle 4
        self.obstacle4 = self.canvas.create_image(pixels * 1.5, pixels * 2.5, anchor='center',
                                                  image=self.obstacle1_object)
        # Obstacle 5
        self.obstacle5 = self.canvas.create_image(pixels * 7.5, pixels * 5.5, anchor='center',
                                                  image=self.obstacle1_object)
        # Obstacle 6
        self.obstacle6 = self.canvas.create_image(pixels * 6.5, pixels * 7.5, anchor='center',
                                                  image=self.obstacle1_object)
        
        # Obstacle 7
        self.obstacle7 = self.canvas.create_image(pixels * 6.5, pixels * 1.5, anchor='center',
                                                  image=self.obstacle1_object)
        
        # Obstacle 8
        self.obstacle8 = self.canvas.create_image(pixels * 4.5, pixels * 4.5, anchor='center',
                                                  image=self.obstacle1_object)
        
        # Obstacle 9
        self.obstacle9 = self.canvas.create_image(pixels * 3.5, pixels * 5.5, anchor='center',
                                                  image=self.obstacle1_object)
        # Create the Goal
        img_goal = Image.open("images/goal.png")
        self.goal_object = ImageTk.PhotoImage(img_goal)
        self.goal = self.canvas.create_image(pixels * 1.5, pixels * 7.5, anchor='center', image=self.goal_object)

        # Create the Robot
        img_robot = Image.open("images/robot.png")
        self.robot = ImageTk.PhotoImage(img_robot)
        self.agent = self.canvas.create_image(pixels * 3.5, pixels * 0.5, anchor='center', image=self.robot)

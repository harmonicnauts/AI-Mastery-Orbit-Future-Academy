...
class Environment(tk.Tk, object):
    def __init__(self):
        ...
        self.title('RL Q-learning Muzero 1')
    ...
    def build_environment(self):
        ...
        img_obstacle1 = Image.open("images/360_See_Saw.png")
        img_obstacle1 = img_obstacle1.resize((new_width, new_height), Image.LANCZOS)
        self.obstacle1_object = ImageTk.PhotoImage(img_obstacle1)
        # Obstacle type 2 - tree1
        img_obstacle2 = Image.open("images/Bumper_29.png")
        img_obstacle2 = img_obstacle2.resize((new_width, new_height), Image.LANCZOS)
        self.obstacle2_object = ImageTk.PhotoImage(img_obstacle2)
        # Obstacle type 3 - tree2
        img_obstacle3 = Image.open("images/Bumpers.png")
        img_obstacle3 = img_obstacle3.resize((new_width, new_height), Image.LANCZOS)
        self.obstacle3_object = ImageTk.PhotoImage(img_obstacle3)
        # Obstacle type 4 - building1
        img_obstacle4 = Image.open("images/Water.png")
        img_obstacle4 = img_obstacle4.resize((new_width, new_height), Image.LANCZOS)
        self.obstacle4_object = ImageTk.PhotoImage(img_obstacle4)
        # Obstacle type 5 - building2
        img_obstacle5 = Image.open("images/Gate.png")
        img_obstacle5 = img_obstacle5.resize((new_width, new_height), Image.LANCZOS)
        self.obstacle5_object = ImageTk.PhotoImage(img_obstacle5)
        # Obstacle type 6 - road closed2
        img_obstacle6 = Image.open("images/Pendulum.png")
        img_obstacle6 = img_obstacle6.resize((new_width, new_height), Image.LANCZOS)
        self.obstacle6_object = ImageTk.PhotoImage(img_obstacle6)
        # Obstacle type 7 - road closed3
        img_obstacle7 = Image.open("images/Rhino1.png")
        img_obstacle7 = img_obstacle7.resize((new_width, new_height), Image.LANCZOS)
        self.obstacle7_object = ImageTk.PhotoImage(img_obstacle7)
        # Obstacle type 8 - traffic lights
        img_obstacle8 = Image.open("images/Rotating_hammer.png")
        img_obstacle8 = img_obstacle8.resize((new_width, new_height), Image.LANCZOS)
        self.obstacle8_object = ImageTk.PhotoImage(img_obstacle8)
        # Obstacle type 9 - pedestrian
        img_obstacle9 = Image.open("images/Yeetus_29.png")
        img_obstacle9 = img_obstacle9.resize((new_width, new_height), Image.LANCZOS)
        self.obstacle9_object = ImageTk.PhotoImage(img_obstacle9)
        # Obstacle type 10 - shop
        img_obstacle10 = Image.open("images/Rhino1.png")
        img_obstacle10 = img_obstacle10.resize((new_width, new_height), Image.LANCZOS)
        self.obstacle10_object = ImageTk.PhotoImage(img_obstacle10)
        # Obstacle type 11 - bank1
        img_obstacle11 = Image.open("images/Bumper_29.png")
        img_obstacle11 = img_obstacle11.resize((new_width, new_height), Image.LANCZOS)
        self.obstacle11_object = ImageTk.PhotoImage(img_obstacle11)
        # Obstacle type 12 - bank2
        img_obstacle12 = Image.open("images/Rotating_hammer.png")
        img_obstacle12 = img_obstacle12.resize((new_width, new_height), Image.LANCZOS)
        ...
        # Obstacle 6
        self.obstacle6 = self.canvas_widget.create_image(pixels * 3, pixels * 6, anchor='nw', image=self.obstacle7_object)
        # Obstacle 7
        self.obstacle7 = self.canvas_widget.create_image(pixels * 7, pixels * 5, anchor='nw', image=self.obstacle9_object)
        # Obstacle 8
        self.obstacle8 = self.canvas_widget.create_image(pixels * 5, pixels * 6, anchor='nw', image=self.obstacle10_object)
        # Obstacle 9
        self.obstacle9 = self.canvas_widget.create_image(pixels * 5, pixels * (5 - 3), anchor='nw', image=self.obstacle4_object)
        # Obstacle 10
        self.obstacle10 = self.canvas_widget.create_image(pixels * 6, pixels * (5 - 3), anchor='nw', image=self.obstacle4_object)
        # Obstacle 11
        self.obstacle11 = self.canvas_widget.create_image(pixels * 5, pixels * (6 - 3), anchor='nw', image=self.obstacle4_object)
        # Obstacle 12
        self.obstacle12 = self.canvas_widget.create_image(pixels * 5, pixels * (7 - 3), anchor='nw', image=self.obstacle4_object)
        # Obstacle 13
        ...
        # Obstacle 17
        self.obstacle17 = self.canvas_widget.create_image(pixels * 6, pixels * (7 - 3), anchor='nw', image=self.obstacle4_object)
        # Obstacle 18
        self.obstacle18 = self.canvas_widget.create_image(pixels, pixels * 6, anchor='nw', image=self.obstacle11_object)
        # Obstacle 19
        self.obstacle19 = self.canvas_widget.create_image(pixels * 5, pixels * 7, anchor='nw', image=self.obstacle8_object)
        # Obstacle 20
        self.obstacle20 = self.canvas_widget.create_image(pixels * 7, pixels * 4, anchor='nw', image=self.obstacle4_object)
        # Obstacle 21
        self.obstacle21 = self.canvas_widget.create_image(pixels * 7, pixels * (5 - 3), anchor='nw', image=self.obstacle4_object)
        # Obstacle 22
        self.obstacle22 = self.canvas_widget.create_image(pixels * 2, pixels * 3, anchor='nw', image=self.obstacle2_object)

        # Final Point
        img_flag = Image.open("images/finish_line.png")
        img_flag = img_flag.resize((new_width, new_height), Image.LANCZOS)
        self.flag_object = ImageTk.PhotoImage(img_flag)
        self.flag = self.canvas_widget.create_image(pixels * 6, pixels * (6-3), anchor='nw', image=self.flag_object)

        # Uploading the image of Mobile Robot
        img_robot = Image.open("images/buff_fall.png")
        img_robot = img_robot.resize((new_width, new_height), Image.LANCZOS)
        self.robot = ImageTk.PhotoImage(img_robot)

        # Creating an agent with photo of Mobile Robot
        self.agent = self.canvas_widget.create_image(pixels * 0, pixels * 6, anchor='nw', image=self.robot)
